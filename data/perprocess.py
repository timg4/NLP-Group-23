#!/usr/bin/env python
"""
Preprocess FinCorpus-DE10k 
-------------------------------------------------------------
 - light normalization including whitespace cleanup and protection for legal abbreviations
...
def protect_abbrev(text: str) -> str:
    """This replaces '.' in known abbreviations with a placeholder."""
...
def preprocess(output_path: Path, max_docs: int | None = None):
    ...
    #here we take a random sample so we get documents from all collections
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Preprocess FinCorpus-DE10k to CoNLL-U file.")
