#!/usr/bin/env python3
"""
Run milestone2 TokenNB (data priors) on stratified 80/20 split.
"""
import argparse
import os
import sys
...
def parse_args():
    ...
    parser.add_argument(
        "--results-dir",
        default=os.path.join(THIS_DIR, "results", "TokenNB_data_priors"),
...
def main():
    ...
    model = TokenNB(use_uniform_priors=False)
    ...
    write_metrics(out_dir, "TokenNB_data_priors", report_text, report_dict, elapsed)
